...
def get_gspread_client():
    try:
        # Mengambil dari secrets yang sudah kita save tadi
        # Perhatikan: tidak ada dict(st.secrets["gcp"]) karena kita simpan langsung
        creds_dict = {
...
if client:
    ...
    st.warning("Client gagal dibuat. Pastikan Email Service Account di-Share sebagai Editor.")
